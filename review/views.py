...
class SubmitReviewView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        form.instance.rating = form.cleaned_data['rating']  # اضافه کردن مقدار امتیاز به مدل
        form.save()
        product = form.cleaned_data['product']
        messages.success(self.request, "دیدگاه شما با موفقیت ثبت شد و پس از بررسی نمایش داده خواهد شد")
        return redirect(reverse_lazy('product:product-detail', kwargs={"slug": product.slug}))
